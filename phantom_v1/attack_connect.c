...
do_connect(struct sockaddr_in *serv_addr) 
{
  ...
  /* NOTE: 1.1.1.1 is owned by cloudflare and is not malicious. We just 
   * assume it is a malicious IP that the attacker wants to connect to 
   * illustrate the idea */
  const char malicious_ip[] = "1.1.1.1";
